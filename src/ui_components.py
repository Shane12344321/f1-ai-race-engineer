...
class WeatherComponent(BaseComponent):
    ...
    def draw(self, window):
        ...
        rect = arcade.XYWH(self.left + 85, panel_top - 65, 180, 150)
        arcade.draw_rect_filled(rect, (15, 15, 25, 220))
        arcade.draw_rect_outline(rect, (60, 60, 80, 255), 1)
...
class LeaderboardComponent(BaseComponent):
    ...
    def draw(self, window):
        ...
        # Draw glassmorphism background
        bg_height = (len(self.entries) * self.row_height) + 60
        if bg_height > 0:
            bg_y = leaderboard_y - (bg_height / 2) + 20
            rect = arcade.XYWH(self.x + self.width/2 - 10, bg_y, self.width + 40, bg_height)
            arcade.draw_rect_filled(rect, (15, 15, 25, 220))
            arcade.draw_rect_outline(rect, (60, 60, 80, 255), 1)

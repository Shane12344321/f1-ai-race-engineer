...
class InsightsMenu(QMainWindow):
    ...
    def __init__(self):
        ...
        self.apply_f1_styling()
        self.setup_ui()
        
    def apply_f1_styling(self):
        # Premium Dark F1 TV-style Theme
        self.setStyleSheet("""
            QMainWindow {
            ...
            QPushButton:hover {
                ...
                border: 1px solid #E10600; /* F1 Red Accent */
            }
            QPushButton:pressed {
    ...
    def create_header(self):
        ...
        subtitle.setStyleSheet("color: #888899;")
    ...
    def create_footer(self):
        ...
        info_label.setStyleSheet("color: #888899;")
    ...
    def create_category_section(self, category_name, insights):
        ...
        category_label.setStyleSheet("color: #E10600; letter-spacing: 1px;")
    ...
    def launch_timing_tower(self):
        print("🚀 Launching: Live Timing Tower")
